...
INSERT INTO `xxl_job_info`(`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`,
                           ...
                           `trigger_next_time`)
VALUES (1, 1, '布隆过滤器重置任务', NOW(), NOW(), 'zmbdpprd', '',
        'CRON', '0 0 4 * * ?', 'DO_NOTHING', 'FIRST',
        'resetBloomFilterJobHandler', '', 'SERIAL_EXECUTION', 0, 1,
        'BEAN', '', 'GLUE代码初始化', NOW(), '', 0, 0, 0);

-- 初始化管理员用户（用户名：zmbdpprd  密码：Hf@173503494 MD5加密）
INSERT INTO `xxl_job_user`(`id`, `username`, `password`, `role`, `permission`)
VALUES (1, 'zmbdpprd', 'c0b20f8a9f3316307ce238f020513d62', 1, NULL);
