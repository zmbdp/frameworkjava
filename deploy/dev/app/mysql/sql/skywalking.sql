...
-- 创建数据库
CREATE
DATABASE IF NOT EXISTS `frameworkjava_skywalking_dev` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE
`frameworkjava_skywalking_dev`;

-- 授权
GRANT ALL PRIVILEGES ON frameworkjava_skywalking_dev.* TO
'zmbdpdev'@'%';
FLUSH
PRIVILEGES;
